...
(function() {
    ...
    const MERGED_PROVINCES = {
        ...
        'vinh phuc': ['phu tho', 'vinh phuc'],
        'bac ninh': ['bac ninh', 'bac giang'],
        'bac giang': ['bac ninh', 'bac giang'],
        'hai duong': ['hai duong', 'hung yen'],
        'hung yen': ['hai duong', 'hung yen'],
        'ninh binh': ['ninh binh', 'ha nam', 'nam dinh'],
        'ha nam': ['ninh binh', 'ha nam', 'nam dinh'],
        'nam dinh': ['ninh binh', 'ha nam', 'nam dinh'],
        'quang tri': ['quang tri', 'quang binh', 'thua thien hue'],
        'quang binh': ['quang tri', 'quang binh', 'thua thien hue'],
        'thua thien hue': ['quang tri', 'quang binh', 'thua thien hue'],
        'da nang': ['da nang', 'quang nam'],
        'quang nam': ['da nang', 'quang nam'],
        'quang ngai': ['quang ngai', 'binh dinh'],
        'binh dinh': ['quang ngai', 'binh dinh'],
        'gia lai': ['gia lai', 'kon tum'],
        'kon tum': ['gia lai', 'kon tum'],
        'khanh hoa': ['khanh hoa', 'phu yen'],
        'phu yen': ['khanh hoa', 'phu yen'],
        'ninh thuan': ['ninh thuan', 'binh thuan'],
        'binh thuan': ['ninh thuan', 'binh thuan'],
        'dak lak': ['dak lak', 'dak nong'],
        'dak nong': ['dak lak', 'dak nong'],
        'binh duong': ['binh duong', 'binh phuoc'],
        'binh phuoc': ['binh duong', 'binh phuoc'],
        'can tho': ['can tho', 'hau giang', 'soc trang'],
        'hau giang': ['can tho', 'hau giang', 'soc trang'],
        'soc trang': ['can tho', 'hau giang', 'soc trang'],
        'vinh long': ['vinh long', 'tra vinh'],
        'tra vinh': ['vinh long', 'tra vinh'],
        'ca mau': ['ca mau', 'bac lieu'],
        'bac lieu': ['ca mau', 'bac lieu'],
        'nghe an': ['nghe an', 'ha tinh'],
        'ha tinh': ['nghe an', 'ha tinh'],
        'cao bang': ['cao bang', 'lang son'],
        'lang son': ['cao bang', 'lang son']
    };
