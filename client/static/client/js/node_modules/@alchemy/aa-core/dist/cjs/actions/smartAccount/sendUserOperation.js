...
const sendUserOperation = async (client, args) => {
    ...
    if (!(0, isSmartAccountClient_js_1.isBaseSmartAccountClient)(client)) {
        throw new client_js_1.IncompatibleClientError("BaseSmartAccountClient", "sendUserOperation");
    }
    const uoStruct = await (0, buildUserOperation_js_1.buildUserOperation)(client, args);
    return (0, sendUserOperation_js_1._sendUserOperation)(client, { account, uoStruct });
};
