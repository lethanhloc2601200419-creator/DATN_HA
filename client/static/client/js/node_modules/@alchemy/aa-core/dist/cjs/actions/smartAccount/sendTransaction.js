...
const sendTransaction = async (client, args) => {
    ...
    if (!(0, isSmartAccountClient_js_1.isBaseSmartAccountClient)(client)) {
        throw new client_js_1.IncompatibleClientError("BaseSmartAccountClient", "sendTransaction");
    }
    const uoStruct = await (0, buildUserOperationFromTx_js_1.buildUserOperationFromTx)(client, args);
