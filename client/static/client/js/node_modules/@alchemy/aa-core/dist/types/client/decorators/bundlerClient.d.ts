import type { Address, Chain, Client, Hash, PublicRpcSchema, Transport } from "viem";
...
export type BundlerActions = {
     ...
     */
    sendRawUserOperation(request: UserOperationRequest, entryPoint: Address): Promise<Hash>;
    /**
