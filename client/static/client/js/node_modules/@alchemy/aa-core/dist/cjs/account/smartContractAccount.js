...
exports.toSmartContractAccount = exports.getAccountAddress = exports.parseFactoryAddressFromAccountInitCode = void 0;
...
const getAccountAddress = async ({ client, entrypointAddress, accountAddress, getAccountInitCode, }) => {
    if (accountAddress)
        return accountAddress;
    const entrypoint = (0, viem_1.getContract)({
...
async function toSmartContractAccount({ transport, chain, source, entrypointAddress, accountAddress, getAccountInitCode, signMessage, signTypedData, encodeBatchExecute, encodeExecute, getDummySignature, signUserOperationHash, encodeUpgradeToAndCall, }) {
    ...
    const [factoryAddress] = (0, exports.parseFactoryAddressFromAccountInitCode)(await getAccountInitCode());
