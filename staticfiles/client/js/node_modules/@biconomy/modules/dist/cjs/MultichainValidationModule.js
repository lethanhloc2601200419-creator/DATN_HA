...
class MultiChainValidationModule extends BaseValidationModule_js_1.BaseValidationModule {
    ...
    async signUserOpHash(userOpHash) {
        const sig = await this.signer.signMessage((0, viem_1.toBytes)(userOpHash));
        return sig;
    }
    ...
    async signUserOps(multiChainUserOps) {
        try {
            ...
            let multichainSignature = await this.signer.signMessage((0, viem_1.toBytes)(merkleTree.getHexRoot()));
