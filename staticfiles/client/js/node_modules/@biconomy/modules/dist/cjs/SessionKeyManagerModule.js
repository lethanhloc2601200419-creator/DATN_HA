...
class SessionKeyManagerModule extends BaseValidationModule_js_1.BaseValidationModule {
    constructor(moduleConfig) {
        ...
        Object.defineProperty(this, "createSessionData", {
            ...
            value: async (leavesData) => {
                const sessionKeyManagerModuleABI = (0, viem_1.parseAbi)(["function setMerkleRoot(bytes32 _merkleRoot)"]);
                const leavesToAdd = [];
                const sessionIDInfo = [];
    ...
    async signUserOpHash(userOpHash, params) {
        ...
        const { signer: sessionSigner } = await (0, common_1.convertSigner)(params.sessionSigner);
