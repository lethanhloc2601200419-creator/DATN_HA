...
export type BaseSmartAccountParams<TTransport extends Transport = Transport, TOwner extends SmartAccountSigner | undefined = SmartAccountSigner | undefined> = z.input<ReturnType<typeof createBaseSmartAccountParamsSchema<TTransport, TOwner>>>;
export type SimpleSmartAccountParams<TTransport extends Transport = Transport, TOwner extends SmartAccountSigner = SmartAccountSigner> = z.input<ReturnType<typeof SimpleSmartAccountParamsSchema<TTransport, TOwner>>>;
export interface ISmartContractAccount<TTransport extends Transport = Transport, TOwner extends SmartAccountSigner | undefined = SmartAccountSigner | undefined> {
